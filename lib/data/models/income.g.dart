...
const IncomeSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.byte,
      enumMap: _IncometypeEnumValueMap,
    ),
...
Income _incomeDeserialize(
  ...
  object.type = _IncometypeValueEnumMap[reader.readByteOrNull(offsets[4])] ??
      IncomeType.cash;
  return object;
}
...
P _incomeDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (_IncometypeValueEnumMap[reader.readByteOrNull(offset)] ??
          IncomeType.cash) as P;
    case 5:
...
const _IncometypeEnumValueMap = {
  'cash': 0,
  'upi': 1,
  'bankTransfer': 2,
  'other': 3,
};
const _IncometypeValueEnumMap = {
  0: IncomeType.cash,
  1: IncomeType.upi,
  2: IncomeType.bankTransfer,
  3: IncomeType.other,
};
...
extension IncomeQueryFilter on QueryBuilder<Income, Income, QFilterCondition> {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeEqualTo(
      IncomeType value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'type',
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeGreaterThan(
    IncomeType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLessThan(
    IncomeType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeBetween(
    IncomeType lower,
    IncomeType upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLabelEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLabelGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLabelLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLabelBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLabelStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLabelEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLabelContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLabelMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLabelIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'typeLabel',
        value: '',
  ...
  QueryBuilder<Income, Income, QAfterFilterCondition> typeLabelIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'typeLabel',
        value: '',
...
extension IncomeQuerySortBy on QueryBuilder<Income, Income, QSortBy> {
  ...
  QueryBuilder<Income, Income, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<Income, Income, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }

  QueryBuilder<Income, Income, QAfterSortBy> sortByTypeLabel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'typeLabel', Sort.asc);
    });
  }

  QueryBuilder<Income, Income, QAfterSortBy> sortByTypeLabelDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension IncomeQuerySortThenBy on QueryBuilder<Income, Income, QSortThenBy> {
  ...
  QueryBuilder<Income, Income, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<Income, Income, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }

  QueryBuilder<Income, Income, QAfterSortBy> thenByTypeLabel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'typeLabel', Sort.asc);
    });
  }

  QueryBuilder<Income, Income, QAfterSortBy> thenByTypeLabelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'typeLabel', Sort.desc);
    });
  }
...
extension IncomeQueryWhereDistinct on QueryBuilder<Income, Income, QDistinct> {
  ...
  QueryBuilder<Income, Income, QDistinct> distinctByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'type');
    });
  }

  QueryBuilder<Income, Income, QDistinct> distinctByTypeLabel(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension IncomeQueryProperty on QueryBuilder<Income, Income, QQueryProperty> {
  ...
  QueryBuilder<Income, IncomeType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'type');
    });
  }

  QueryBuilder<Income, String, QQueryOperations> typeLabelProperty() {
    return QueryBuilder.apply(this, (query) {
